        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('bookinstances.index') }}" :active="request()->routeIs('bookinstances.index')">
                        {{ __('Book Copies') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('books.create') }}" :active="request()->routeIs('books.create')">
                        {{ __('Add Book') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('bookinstances.create') }}" :active="request()->routeIs('bookinstances.create')">
                        {{ __('Add Book Copy') }}
                    </x-jet-nav-link>
                </div>
            </div>
